...
const subDevices = ref([
  ...
  { id: 'sub5', name: '一氧化碳探测器', type: 'co_detector', category: 'co_detector', online: true, value: '安全', unit: '' },
  { id: 'sub6', name: '水浸传感器', type: 'water_sensor', category: 'water_sensor', online: true, value: '正常', unit: '' },
  { id: 'sub7', name: '环境探测器', type: 'env_detector', category: 'env_detector', online: true, value: '优', unit: '' },
  { id: 'sub8', name: '红外对射', type: 'infrared_beam', category: 'infrared_beam', online: true, value: '正常', unit: '' },
  { id: 'sub9', name: '震动传感器', type: 'vibration', category: 'vibration', online: false, lastUpdate: '08:15' },
  { id: 'sub10', name: '玻璃破碎探测器', type: 'glass_break', category: 'glass_break', online: true, value: '正常', unit: '' },
  { id: 'sub11', name: '跌倒探测器', type: 'fall_detector', category: 'fall_detector', online: true, value: '正常', unit: '' },
  { id: 'sub12', name: '门铃', type: 'doorbell', category: 'doorbell', online: true, value: '待机', unit: '' },
])
